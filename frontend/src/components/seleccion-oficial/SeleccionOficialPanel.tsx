/**
 * Selección Oficial — shared admin-managed roster panel.
 *
 * Extracted from the two identical page wrappers
 * (`app/groups/seleccion-oficial/page.tsx` and
 * `app/ranking/seleccion-oficial/page.tsx`) to eliminate duplication.
 *
...
export default function SeleccionOficialPanel({
  eyebrow = "Grupos de Entrenamiento",
  title = "Selección Oficial",
}: SeleccionOficialPanelProps): React.ReactElement {
